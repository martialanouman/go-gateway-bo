/**
 * `/groupes` — **route déclarée, écran non encore livré (M3)**.
 *
...
export const Route = createFileRoute('/_shell/groupes')({
  ...
  return (
    <Page title="Groupes">
      <Empty
        ...
        description="Les groupes de clients et leur composition. Cette route est déclarée pour que la navigation soit complète ; son contenu arrive au jalon M3."
      />
    </Page>
  )
}
