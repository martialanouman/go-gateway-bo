...
#
# Les cibles client (`test-web`, `lint-web`, `mock`, `generate`, `migrate`, `bootstrap`) arrivent avec
# les steps qui les habitent. Aucune cible vide ici : une cible qui ne fait rien passe pour verte.
