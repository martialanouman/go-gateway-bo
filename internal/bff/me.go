...
// vigilance. **Ce n'est pas une affirmation mais une propriété gardée** — un `Operator` posé ici ne
// passerait pas sans bruit.
...
// Ce qui le garde tout de même est la règle de **provenance** — le type vient du fichier engendré,
// donc son `Visit…` aussi — et le scénario qui confronte la réponse au contrat.
