...
// de CI. La rédaction de pgx n'est pas hermétique : mesuré sur v5.10.0, ses deux expressions
// rationnelles couvrent `postgres://u:xxxxx@…` et `password=xxxxx`, mais laissent passer
